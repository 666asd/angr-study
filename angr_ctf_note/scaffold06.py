...
def main(argv):
  ...
  pointer_to_malloc_memory_address0 = 0x3a298c0 + 0x404000
  pointer_to_malloc_memory_address1 = 0x3a298c4 + 0x404000
  ...
  if simulation.found:
    ...
    solution1 = solution_state.se.eval(password1, cast_to=bytes).decode("utf8")
