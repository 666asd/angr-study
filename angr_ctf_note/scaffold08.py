...
def main(argv):
  ...
  start_address = 0x0040135e
  initial_state = project.factory.blank_state(addr=start_address)

  password = claripy.BVS('password', 8*0x10)

  password_address = 0x00404040
  ...
  # (!)
  address_to_check_constraint = 0x00401278
  ...
  if simulation.found:
    ...
    # (!)
    constrained_parameter_desired_value = "NWZKNFSOGUFXOYIG" # :string
