...
def main(argv):
  ...
  class ReplacementCheckEquals(angr.SimProcedure):
    ...
    def run(self, to_check, buf_len):
      ...
      user_input_buffer_length = buf_len
      ...
      check_against_string = "WBAFGKBVTMSRIVQI"
  ...
  # (!)
  check_equals_symbol = 'check_equals_WBAFGKBVTMSRIVQI' # :string
