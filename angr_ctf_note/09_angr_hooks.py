...
def main(argv):
  ...
  # (!)
  check_equals_called_address = 0x00401288
  ...
  # (!)
  instruction_to_skip_length = 0x004012e7 - 0x00401288
  ...
  def skip_check_equals_(state):
    ...
    user_input_buffer_address = 0x00404044 # :integer, probably hexadecimal
    ...
    # it.
    check_against_string = 'VDHCSLVAPNXSNBNR' # :string
